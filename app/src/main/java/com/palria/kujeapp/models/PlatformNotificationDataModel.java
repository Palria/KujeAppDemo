...
public class PlatformNotificationDataModel {
    ...
    public PlatformNotificationDataModel(String notificationId, String title, String message, String dateNotified, ArrayList<String> notificationViewers){
