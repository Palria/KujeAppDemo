...
//    String commentingPostId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parentView = inflater.inflate(R.layout.fragment_all_products, container, false);
...
//                progressIndicatorShimmerLayout = GlobalValue.showShimmerLayout(getContext(), containerLinearLayout);
        ...
        urlList.add("url");
//      productDataModels.add( new ProductDataModel("productId","Chair", "30","For sitting1","2002",urlList,false));
//      productDataModels.add( new ProductDataModel("productId","Chair1","50","For sitting2","2003",urlList,false));
//      productDataModels.add( new ProductDataModel("productId","Chair2","90","For sitting3","2004",urlList,false));
//      productDataModels.add( new ProductDataModel("productId","Chair3","300","For sitting4","2005",urlList,false));
//      productDataModels.add( new ProductDataModel("productId","Chair4","80","For sitting5","2006",urlList,false));
//      productDataModels.add( new ProductDataModel("productId","Chair5","20","For sitting6","2007",urlList,false));
