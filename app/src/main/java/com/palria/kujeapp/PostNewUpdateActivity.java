...
public class PostNewUpdateActivity extends AppCompatActivity {
...
//    postDetails.put("UPDATE_IMAGE_DOWNLOAD_URL_" + numberOfImagesUploadCounter, "EMPTY");
//    postDetails.put("UPDATE_IMAGE_STORAGE_REFERENCE_" + numberOfImagesUploadCounter, "EMPTY");
        ...
        postDetails.put(GlobalValue.LAST_UPDATE_ID, postId);
