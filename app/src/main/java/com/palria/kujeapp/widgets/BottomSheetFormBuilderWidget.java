package com.palria.kujeapp.widgets;
...
public class BottomSheetFormBuilderWidget extends BottomSheetDialog {
   ...
   protected LinearLayout formLayout;
    ...
    String actionButtonTitle="Create";
    String title = "";
    ...
    public BottomSheetFormBuilderWidget render(String actionButtonTitle){
        ...
        positiveButton.setText(actionButtonTitle);
        positiveButton.setBackground(context.getDrawable(R.drawable.default_auth_btn));
//        positiveButton.setBackgroundColor(context.getResources().getColor(R.color.secondary_app_color,context.getTheme()));
...
//                    }
//                }
                EditTextInput editTextInputTitle = (EditTextInput) inputLists.get(0);
                title = editTextInputTitle.getText()+"";
                EditTextInput editTextInputBody;
                String body = "";

                if(inputLists.size()>1){
                    editTextInputBody = (EditTextInput) inputLists.get(1);
                    body = editTextInputBody.getText()+"";
                }

                onSubmitListener.onSubmit(title,body);
    ...
    public EditTextInput addInputField(EditTextInput input){
    ...
    public interface onSubmit{
        void onSubmit(String title, String body);
    }
