...
//            });
    ...
    private void loadCurrentUserProfile(){
        getProfile(new OnUserProfileFetchListener() {
            @Override
            public void onSuccess(String userDisplayName, String userCountryOfResidence, String contactEmail, String contactPhoneNumber, String genderType, String userProfilePhotoDownloadUrl, String joined_date, boolean isUserBlocked, boolean isUserProfilePhotoIncluded) {
        ...
        GlobalValue.getFirebaseFirestoreInstance().collection(GlobalValue.ALL_USERS).document(userId)
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        String contactEmail =""+ documentSnapshot.get(GlobalValue.USER_EMAIL_ADDRESS);
                        ...
                        onUserProfileFetchListener.onSuccess( userDisplayName, userCountryOfResidence, contactEmail, contactPhoneNumber, genderType, userProfilePhotoDownloadUrl,joined_date, isUserBlocked, isUserProfilePhotoIncluded);
                    }
                });
    }
...
//                }
        ...
        tabLayout.addTab(ordersItem,0);

        TabLayout.Tab requestsItem = tabLayout.newTab();
        requestsItem.setText("My Requests");
        tabLayout.addTab(requestsItem,1);
//
//        TabLayout.Tab productsItem = tabLayout.newTab();
//        productsItem.setText("My Products");
//        tabLayout.addTab(productsItem,2);
//
//        TabLayout.Tab productsItem2 = tabLayout.newTab();
//        productsItem2.setText("My Products22222");
//        tabLayout.addTab(productsItem2,3,true);
//
...
//        tabLayout.addTab(ordersItem,1);
    ...
    interface OnUserProfileFetchListener{
        void onSuccess(String userDisplayName,String userCountryOfResidence,String contactEmail,String contactPhoneNumber,String genderType,String userProfilePhotoDownloadUrl,String joined_date,boolean isUserBlocked,boolean isUserProfilePhotoIncluded);
