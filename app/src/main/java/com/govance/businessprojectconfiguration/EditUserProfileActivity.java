...
//                                            });
                                            ...
                                            GlobalValue.showAlertMessage("success",
                                                    ...
                                                    "Profile Edited Successfully.",
                                                    "You have successfully edited your profile, "+getResources().getString(R.string.app_name)+" has more goods to sell , go ahead and order more.");
...
//                                    });
                        ...
                        editUserProfile("","", new ProfileCreationListener() {
                            ...
                            public void onSuccess(String userName) {
                                //succeed in editing profile
//                                GlobalValue.updateActivityLog(GlobalValue.ACTIVITY_LOG_USER_EDIT_ACCOUNT_TYPE_KEY, GlobalValue.getCurrentUserId(), null, null,  null, null, null, new GlobalValue.ActionCallback() {
//                                    @Override
//                                    public void onSuccess() {
//
//                                        GlobalValue.showAlertMessage("success",
...
//
                            ...
                            public void onFailed(String errorMessage) {
                                ...
                                GlobalValue.showAlertMessage("error",
                                        EditUserProfileActivity.this,
                                        "Profile Edition Failed.",
                                        "Your profile edition failed, please try again.");
//
                            }
                        });
                    }
...
//        DocumentReference userProfileDocumentReference = GlobalConfig.getFirebaseFirestoreInstance().collection(GlobalConfig.ALL_USERS_KEY).document(GlobalConfig.getCurrentUserId()).collection(GlobalConfig.USER_PROFILE_KEY).document(GlobalConfig.getCurrentUserId());
        ...
        userProfileDetails.put(GlobalValue.IS_EDITION,true);
//        userProfileDetails.put(GlobalValue.TOTAL_NUMBER_OF_AUTHOR_REVIEWS_KEY,FieldValue.increment(0L));
        userProfileDetails.put(GlobalValue.IS_USER_BLOCKED,isUserBlocked);
        userProfileDetails.put(GlobalValue.USER_EMAIL_ADDRESS,contactEmail);
        userProfileDetails.put(GlobalValue.USER_COVER_PHOTO_DOWNLOAD_URL,userProfilePhotoDownloadUrl);
//        userProfileDetails.put(GlobalValue.USER_PROFILE_PHOTO_STORAGE_REFERENCE_KEY,profilePhotoStorageReference);
...
//                        String profilePhotoStorageReference =""+ documentSnapshot.get(GlobalValue.USER_PROFILE_PHOTO_STORAGE_REFERENCE_KEY);
                        boolean isUserBlocked = false;
